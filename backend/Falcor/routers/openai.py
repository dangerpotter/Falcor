...
from Falcor.env import ENV, SRC_LOG_LEVELS
        ...
        try:
            r = requests.post(
                ...
                headers={
                    ...
                    **(
                        {
                            "HTTP-Referer": "https://strategicedinc.sharepoint.com/:u:/r/sites/CUCourseDev-OpsTeam/SitePages/Falcor.aspx?csf=1&web=1&e=uAImqs",
                            "X-Title": "Falcor",
                        }
                    ...
                    **(
                        {
                            "X-Falcor-User-Name": user.name,
                            "X-Falcor-User-Id": user.id,
                            "X-Falcor-User-Email": user.email,
                            "X-Falcor-User-Role": user.role,
                        }
            ...
            raise HTTPException(
                ...
                detail=detail if detail else "Falcor: Server Connection Error",
            )
    ...
    if url_idx is None:
        ...
        async with aiohttp.ClientSession(
            ...
            try:
                ...
                raise HTTPException(
                    status_code=500, detail="Falcor: Server Connection Error"
                )
            except Exception as e:
